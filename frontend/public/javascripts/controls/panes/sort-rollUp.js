  ...
  $.Control.extend('pane_sortRollUp', {
          ...
          fields: [{
            ...
            field: {
              ...
              options: [{
                ...
                notequalto: 'groupColumn',
                useFieldName: true,
                text: $.t('screens.ds.grid_sidebar.sort_rollup.rollup.group_by'),
                columns: {
                  type: this._filteredGroupableTypesForSoda2(this._view),
                  noDefault: true,
            ...
            type: 'repeater',
            minimum: 0,
            name: 'metadata.jsonQuery.select',
        ...
        fields: [{
          ...
          field: {
            ...
            options: [{
              ...
              options: [{
                text: $.t('screens.ds.grid_sidebar.sort_rollup.sort.directions.ascending'),
                value: 'true'
              }, {
                text: $.t('screens.ds.grid_sidebar.sort_rollup.sort.directions.descending'),
                value: 'false'
              }]
            }]
          }
    ...
    shown: function() {
      ...
      if (!cpObj._registeredChange) {
        cpObj._view.bind('query_change', function() {
          cpObj.reset();
        }, cpObj);
    ...
    _finish: function(data, value, finalCallback) {
      ...
      if (!_.isEmpty(filterView.metadata.jsonQuery.group)) {
        filterView.metadata.jsonQuery.group = _.select(filterView.metadata.jsonQuery.group,
          function(gb) {
            return !$.isBlank(gb.columnFieldName);
          });
      }
      ...
      if (_.any(filterView.metadata.jsonQuery.select, function(s) {
        ...
        cpObj.$dom().find('.mainError').text($.t('screens.ds.grid_sidebar.sort_rollup.validation.no_group_bys'));
      ...
      if (!_.isEmpty(filterView.metadata.jsonQuery.group) &&
        _.any(filterView.metadata.jsonQuery.select, function(s) {
          return $.isBlank(s.aggregate) && !_.any(filterView.metadata.jsonQuery.group,
            function(g) {
              return g.columnFieldName == s.columnFieldName;
            });
        })) {
      ...
      if (updatedCols) {
        cpObj._view.trigger('columns_changed');
      }
