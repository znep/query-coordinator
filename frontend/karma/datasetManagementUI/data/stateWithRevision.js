export default {
  entities: {
    ...
    output_schemas: {
      '152': {
        ...
        input_schema_id: 106,
        error_count: 0,
        created_at: new Date(1497553191571),
        created_by: {
          user_id: 'tugg-ikce',
          email: 'brandon.webster@socrata.com',
          display_name: 'branweb'
        ...
        completed_at: new Date(1497553192000)
      }
    },
    output_columns: {
      '2121': {
    ...
    task_sets: {
      '30': {
        ...
        id: 30,
        finished_at: new Date(1497553203000),
        created_by: {
          user_id: 'tugg-ikce',
          email: 'brandon.webster@socrata.com',
          display_name: 'branweb'
        },
        created_at: new Date('2017-06-15T19:00:00.359475Z')
      }
    },
    email_interests: {},
    row_errors: {},
  ...
  ui: {
      ...
      'output_schema:152': {
        ...
        socket: {
          ...
          params: {
            fourfour: 'nn5w-zj56',
            token:
              'SFMyNTY.g3QAAAACZAAEZGF0YW0AAACGeyJkb21haW4iOiJsb2NhbGhvc3QiLCJjb29raWUiOiJkSFZuWnkxcGEyTmxJREUwT1RjMU56UTNOelVnWkRoalpUWTNaR1JoWkRJeElEUTVaVFF3T1dReFpXRmhZbVk1TWpSbVlqRmlNMkptTldaaU1EZGlZVFJqWWpBM1ptRmlPVE09In1kAAZzaWduZWRuBgDsBiCtXAE.7JwyOF9x8lY4RXcxTq6COgE3uS229ZCfYMArYosL2Ys'
          },
    ...
    apiCalls: {
      '01a04af9-d75a-4d25-9184-59f63cd0ea0e': {
      ...
      '31545f2c-d7f1-4afd-b310-d761bb0832c6': {
        ...
        succeededAt: new Date(1497553192779)
      },
      'aae08d59-bd43-4702-b559-3fb026a2bfcd': {
        ...
        startedAt: new Date(1497553192568),
        succeededAt: new Date(1497553194293)
      },
      '29719135-e046-404c-abfe-681d9a285167': {
        ...
        succeededAt: new Date(1497553200456)
      }
    }
  }
};
