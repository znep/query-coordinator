  ...
  $.Control.extend('pane_formCreate', {
    ...
    _getSections: function() {
      return [{
        ...
        fields: [{
          type: 'text',
          text: $.t('screens.ds.grid_sidebar.form.information.name'),
          name: 'name',
          required: true,
          prompt: $.t('screens.ds.grid_sidebar.form.information.name_prompt')
        }, {
          type: 'text',
          text: $.t('screens.ds.grid_sidebar.form.information.success'),
          name: 'displayFormat.successRedirect',
          extraClass: 'url',
          prompt: $.t('screens.ds.grid_sidebar.form.information.success_prompt')
        }, {
          type: 'checkbox',
          text: $.t('screens.ds.grid_sidebar.form.information.public'),
