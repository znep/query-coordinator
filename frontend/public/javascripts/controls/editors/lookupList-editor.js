(function($) {
  var renderValue = function(value) {
    ...
    var $spanLabel = $('<span class="label"></span>').html($.htmlEscape(value.label));
    $row.empty().append($icon).append($spanLabel);
  };
  ...
  $.blistEditor.addEditor('lookupList', {
    editorAdded: function() {
      ...
      editObj.setFullSize();
      editObj.$dom().addClass('blist-combo-wrapper').addClass('combo-container');
