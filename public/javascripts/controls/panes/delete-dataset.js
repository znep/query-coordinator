    ...
    $.Control.extend('pane_deleteDataset', {
        ...
        _getFinishButtons: function() {
            return [
              {
                  isDefault: true,
                  text: $.t('screens.ds.grid_sidebar.delete.delete_button', { view_type: this._view.displayName }),
                  value: true
              },
        ...
        _finish: function(data, value, finalCallback) {
            ...
            if (_.indexOf(this._view.flags, 'restorable') != -1) {
              message = $.t('screens.ds.grid_sidebar.delete.confirm_restorable', { number_of_days_restorable: Dataset.getNumberOfDaysRestorable() });
            } else {
              message = $.t('screens.ds.grid_sidebar.delete.confirm_permanent', { view_type: this._view.displayName });
            }
