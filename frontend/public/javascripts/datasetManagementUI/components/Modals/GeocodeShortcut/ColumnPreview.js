...
import columnHeaderStyles from 'styles/Table/ColumnHeader.scss';
...
const ColumnPreview = ({
  ...
  if (!anySelected) {
    body = (<div className={styles.noColumnYet}>
      <div className={styles.noOutputColumn}>
        <p className={styles.beginGeoreferencing}> {SubI18n.begin_georeferencing} </p>
      </div>
    </div>);
  ...
  return (<div className={styles.columnPreviewWrap}>
