(function($, root) {
  ...
  $.fn.socrataChoroplethMap = function(vif) {
    ...
    var visualization = new visualizations.ChoroplethMap($element, vif);
    ...
    var unfilteredSoqlDataProvider = new visualizations.SoqlDataProvider(
      soqlDataProviderConfig
    );

    var filteredSoqlDataProvider = new visualizations.SoqlDataProvider(
      soqlDataProviderConfig
    );
    ...
    var geospaceDataProvider = new visualizations.GeospaceDataProvider(
