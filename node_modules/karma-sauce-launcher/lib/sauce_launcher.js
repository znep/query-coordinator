...
var SauceLauncher = function(args, sauceConnect, /* config.sauceLabs */ config, logger, helper,
  ...
  this.on('kill', function(done) {
    ...
    if (sessionIsReady) {
      ...
      // SOCRATA (gferrari 1/26/2015): Temporary workaround for disconnection timeout. We have a support
      // ticket with SauceLabs (https://support.saucelabs.com/requests/17533). This workaround allows the
      // tests to actually terminate, but the side effects of doing this are unclear. It probably breaks
      // --singleRun=false while running the tests in Sauce under certain apocryphal circumstances.
      //
      // See also the related bug in karma-sauce-launcher:
      // https://github.com/karma-runner/karma-sauce-launcher/issues/14
      //
      // ... and the commit that originally introduced this dubious workaround:
      // https://github.com/johanneswuerbach/karma-sauce-launcher/commit/b04341c106d53ee833518ce9fb7be0139eb2e9f0
      //
      // I'm porting over the proposed workaround from this PR:
      // https://github.com/karma-runner/karma-sauce-launcher/pull/19
