...
protected
  ...
  def render_swf(swf_filename)
    @minFlashVersion = '9.0.45'

#    if not @is_widget
#      @has_lenses = current_user.lenses.count(:all, :include => [:blist], :conditions => "autogenerated <> true and used_as_enum <> true and is_saved = true and is_template = false") > 0
#    end

    @swf_url = swf_url(swf_filename)
#    @current_user = current_user

#    respond_to do |format|
#      format.html { render :partial => 'shared/swf', :layout => true }
#    end
  end
