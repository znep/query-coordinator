...
function Chart (options, callback) {
	...
	function MouseTracker (chart, options) {
      ...
      chart.mouseIsDown = mouseIsDown = hasDragged = false;
			...
			// EN-13693 - attempting to remove either mouse / touch events since we add both now
		...
		function setDOMEvents () {
			...
			container.onmousedown = function(e) {
				...
				// EN-13693 - duplicating callback for touch-enabled laptops
...
//				data[1] ? data[closestPoints].plotX - data[closestPoints - 1].plotX :
            ...
            // JS: Show things no matter what
			pointWidth = mathMax(1, pick(optionPointWidth, pointOffsetWidth - 2 * pointPadding)),
