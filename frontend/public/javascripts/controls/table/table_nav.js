...
blist.data.TableNavigation = function(_model, _layout, _$textarea) {
  var model = _model;
  this.updateModel = function(_newModel) {
    model = _newModel;
  };
  var layout = _layout;
  this.updateLayout = function(_newLayout) {
    layout = _newLayout;
  };
  ...
  var hasSelection = function() {
    ...
    for (var col in selectedColumns) { // eslint-disable-line no-unused-vars
      return true;
    }
