...
function setOuterWidth(element, width, includeMargins) {
	for (var i=0, e; i<element.length; i++) {
		e = $(element[i]);
                // jeff.scherpelz@socrata.com: Better dimension calculations
		e.width(Math.max(0, width - (e.outerWidth(includeMargins) - e.width())));
	}
}
...
function BasicView(element, calendar, viewName) {
	...
	function setWidth(width) {
		...
		colWidth = Math.floor(viewWidth / colCnt);
                // jeff.scherpelz@socrata.com: IE7 doesn't size quite right
		setOuterWidth(headCells.slice(0, -1),
