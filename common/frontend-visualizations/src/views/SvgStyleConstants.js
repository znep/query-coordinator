...
export const LEGEND_RECT_LABEL_GAP = 5;
export const LEGEND_SEPARATOR_COLOR = '#e4e4e4';
export const LEGEND_SEPARATOR_WIDTH = 1;
export const LEGEND_CONTAINER_MARGIN = { top: 16, right: 16, bottom: 16, left: 16};
export const LEGEND_COLUMN_GAP = { horizontal: 16, vertical: 16 };
export const LEGEND_COLUMN_PADDING = { top: 0, right: 0, bottom: 0, left: LEGEND_RECT_SIZE + LEGEND_RECT_LABEL_GAP };
export const LEGEND_MINIMUM_TEXT_WIDTH = 100;
export const LEGEND_CONTAINER_OUTER_MARGIN_BOTTOM = 16;
export const MAX_LEGEND_COLUMNS = 10;
export const AXIS_LABEL_FONT_FAMILY = '"Open Sans", "Helvetica", Arial, sans-serif';
