...
All files and folder in the `common` project must be camel cased (example: `common/feature_flags/index.js`).
...
1. Have a clear camel-cased name. For instance, `feature_flags`.
