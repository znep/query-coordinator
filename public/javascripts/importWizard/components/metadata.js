      ...
      <div className="commonForm metadataForm">
        <div className="externalDatasetMetadata">
          <div className="line clearfix">
            ...
            <input type="text" name="external_sources[0]" className="textPrompt url required"
        ...
        <div className="generalMetadata">
          <div className="line clearfix">
            ...
            <input type="text" name="view[name]" title={ I18nPrefixed.dataset_title_prompt }
          ...
          <div className="line clearfix">
            ...
            <textarea type="text" name="view[description]"
          ...
          <div className="line clearfix">
            ...
            <select name="view[category]" onChange={ (evt) => onMetadataAction(updateCategory(evt.target.value)) }>
              { datasetCategories.map(([name, value]) =>
          ...
          <div className="line clearfix">
            ...
            <input type="text" name="view[tags]" title={ I18nPrefixed.tags_prompt }
          ...
          <div className="line clearfix">
            ...
            <input type="text" name="view[rowLabel]"
              className="textPrompt"
        ...
        <div className="mapLayerMetadata">
          <div className="line clearfix">
            ...
            <input type="text" name="view[mapLayer]"
              className="textPrompt required"
        ...
        <div className="privacyMetadata">
          ...
          <div className="line clearfix">
            <fieldset id="privacy-settings" className="radioblock">
              ...
              <div>
                <input type="radio" name="privacy" value="private" id="privacy_private" defaultChecked
                  onChange={ (evt) => onMetadataAction(updatePrivacySettings(evt.target.value)) }/>
          ...
          <div className="line clearfix">
            ...
            <input type="text" name="view[contactEmail]'"
