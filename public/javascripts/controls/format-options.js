        ...
        return this.each(function()
        {
            ...
            $fmtMenu.find('a.toggleButton').click(function(e)
            {
                ...
                if (!$.isBlank(config.formatEditor))
                {
                    ...
                    if (action == 'link')
                    {
                        if (!newVal) { config.formatEditor.action('unlink'); }
                        else
                        {
                    ...
                    else { config.formatEditor.action(action, newVal); }
                }
            });
            ...
            $fmtMenu.find('.menu.align').menu({
                menuButtonContents:
                    $.tag({tagName: 'span', 'class': 'alignIcon'}, true),
                menuButtonTitle: 'Alignment',
                contents: [
                    { title: 'Align Left', className: 'alignLeft',
                        href: '#format_justifyLeft' },
                    { title: 'Align Center', className: 'alignCenter',
                        href: '#format_justifyCenter' },
                    { title: 'Align Right', className: 'alignRight',
            ...
            $colorItem.colorPicker().bind('color_change', function(e, newColor)
            {
                ...
                $colorItem.children('.colorIndicator')
                    .css('border-bottom-color', newColor);
            })
           ...
           .click(function(e) { e.preventDefault(); });
            ...
            config.$grid.bind('action-state-change', function(e)
            {
                ...
                var $alignment = $fmtMenu.find('.menu.align')
            ...
            config.$grid.bind('edit-finished', function(e)
            {
                $fmtMenu.addClass('disabled')
                    ...
                    .end()
                    .find('.menu.align').removeClass('alignRight alignCenter')
                        .addClass('alignLeft').end()
