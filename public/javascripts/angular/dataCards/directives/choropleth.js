(function() {
  ...
  angular.module('dataCards.directives').directive('choropleth',
    ['AngularRxExtensions', '$timeout', 'numberFormatter', 'ChoroplethVisualizationService',
    function(AngularRxExtensions, $timeout, numberFormatter, ChoroplethVisualizationService) {
      ...
      return {
        ...
        template: '<div class="choropleth-container"><div class="choropleth-map-container"></div><div class="choropleth-legend-container modern-legend"></div></div>',
                  ...
                  Object.keys(map._layers).
                    forEach(function(k) {
                      if (map._layers[k].hasOwnProperty('feature') &&
                          map._layers[k].feature.properties[HIGHLIGHTED_PROPERTY_NAME]) {
