 ...
 *  + Fixed crash after removing picker from DOM
 *  + Disabled week pickers
 *  + Only fire onChange when choosing a date, not month or year
 */
(function ($)
{
  ...
  h : window.innerHeight || (m ? document.documentElement.clientHeight : document.body.clientHeight)
        ...
        hide = function (ev) {
            if (ev.target != ev.data.trigger && !isChildOf(ev.data.cal.get(0), ev.target, ev.data.cal.get(0))) {
                var dp = ev.data.cal.data('datepicker');
                if (dp && dp.onHide.apply(this, [ev.data.cal.get(0)]) != false) {
                    ev.data.cal.hide();
                }
    ...
    $.fn.extend({
        ...
        DatePickerRemove: DatePicker.removePicker,
