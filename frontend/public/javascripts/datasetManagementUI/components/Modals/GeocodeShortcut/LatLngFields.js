...
const composeFromLatLng = (mappings) => {
...
const decomposeFromLatLng = (makePointFunc, outputColumns) => {
  ...
  const latitude = columnMatchingAst(outputColumns, latArg) ||
    columnMatchingAst(outputColumns, stripToNumberAst(latArg));
  const longitude = columnMatchingAst(outputColumns, lngArg) ||
    columnMatchingAst(outputColumns, stripToNumberAst(lngArg));
