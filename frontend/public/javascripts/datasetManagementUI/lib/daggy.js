...
var sum$isVariant = function sum$isVariant(val) {
  return Boolean(val) && this[TAG] === val[TAG] && this[RET_TYPE] === index$2(val);
};

var sum$isUnit = function sum$isUnit(val) {
  return this === val || Boolean(val) && this[TAG] === val[TAG] && index$2(this) === index$2(val);
};

var isType = function isType(val) {
  return this[TYPE] === index$2(val);
};
