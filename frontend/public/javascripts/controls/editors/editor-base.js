(function($) {
  ...
  $.blistEditor = {
    addEditor: function(type, editor, dependsOn) {
      if ($.isBlank(blist.datatypes.interfaceTypes[type])) {
  ...
  $.Control.extend('blistEditor', {
    _init: function() {
      ...
      $domObj.keydown(function(e) {
        handleKeyDown(editObj, e);
      });
    ...
    /**
     * Trigger an action.  Returns true iff the action is executed.
     * Params are name and value.  Value is optional.
     */
    action: function() {
      return false;
    },
