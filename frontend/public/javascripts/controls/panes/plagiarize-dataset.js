      ...
      if (this._view.owner.id != blist.currentUserId) {
        fieldConfig = {
          ...
          options: [{
            ...
            options: [{
              name: 'user',
              value: $.t('screens.ds.grid_sidebar.ownership.me'),
              type: 'static',
              isInput: true
            }, userInput]
          }]
    ...
    _finish: function(data, value, finalCallback) {
      ...
      if (userText == $.t('screens.ds.grid_sidebar.ownership.me')) {
        ...
        if (userText != '' && $.subKeyDefined(cpObj, '_thief.id')) {
          successText = $.t('screens.ds.grid_sidebar.ownership.success.user', {
            owner: cpObj._thief.nameAndOrEmail()
          });
