var templateUrl = require('angular_templates/dataCards/saveVisualizationAsDialog.html');
const angular = require('angular');
function saveVisualizationAsDialog($http, $window, I18n, VIFExportService, FlyoutService, rx) {
  const Rx = rx;
  return {
    restrict: 'E',
    scope: {
            ...
            if (valid) {
              ...
              $http.post('/metadata/v1/standalone_viz.json', payload).
                then(function(response) {
                  ...
                  $window.location = I18n.a(`/view/${response.data.id}`);
                }, function() {
