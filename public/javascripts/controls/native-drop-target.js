  ...
  $.Control.extend('nativeDropTarget', {
    ...
    enable: function(isSoft) {
      ...
      if (!isSoft) {
        ...
        dObj.$dom().on('drop.nativeDropTarget', function(e) {
          ...
          on('dragover.nativeDropTarget', function(e) {
            dObj.dragOver(e);
          }).
          on('dragenter.nativeDropTarget', function(e) {
            dObj.dragEnter(e);
          }).
          on('dragleave.nativeDropTarget', function(e) {
            dObj.dragLeave(e);
          });
    ...
    disable: function(isSoft) {
      ...
      if (!isSoft) {
        ...
        if (!$.isBlank($.nativeDraggable)) {
          $.nativeDraggable.unbind(null, null, this);
        }
        this._enabled = false;
      }
    },
    ...
    dropStandard: function(e) {
      var dObj = this;
      if (!dObj._active || !dObj.canAcceptDrop()) {
        return;
      }
