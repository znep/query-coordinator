(function() {
  ...
  var mapping = [
    ...
    { logical: 'text', physical: 'point', expected: 'pointMap', supported: false },
    { logical: 'name', physical: 'point', expected: 'pointMap', supported: false },
    { logical: 'identifier', physical: 'point', expected: 'pointMap', supported: false },
    ...
    { logical: 'location', physical: 'point', expected: 'pointMap', supported: false },
