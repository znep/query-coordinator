...
Rails.configuration.middleware.insert_after CurrentDomainMiddleware, "LocaleMiddleware"
Rails.configuration.middleware.insert_after LocaleMiddleware, "LogRefererMiddleware"
