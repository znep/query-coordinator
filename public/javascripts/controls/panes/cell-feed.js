(function($) {
  $.Control.extend('pane_cellFeed', {
        ...
        customContent: {
          ...
          directive: {
            ...
            '.columnName': function(c) {
              return $.htmlEscape(cpObj._view.columnForTCID(c.context.tableColumnId).name);
            }
          }
        }
      }, {
    ...
    shown: function() {
      this._super();
      $(document).trigger('cell_feed_shown', [this._cellPaneData.rowId, this._cellPaneData.tableColumnId]);
    },

    hidden: function() {
      this._super();
      $(document).trigger('cell_feed_hidden', [this._cellPaneData.rowId, this._cellPaneData.tableColumnId]);
    }
  }, {
    name: 'cellFeed',
    noReset: true
