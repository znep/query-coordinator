(function($) {
  $.component.Component.extend('Inline filter', 'input', {
    ...
    _getAssets: function() {
      return {
        javascripts: [{
          assets: 'awesomecomplete'
        }, {
          assets: 'columnizer'
        }, {
          assets: 'base-control'
        }, {
          assets: 'shared-editors'
        }, {
          assets: 'unified-filter'
        }],
        stylesheets: [{
          assets: 'base-control'
        }, {
          sheet: '/webfonts/ss-standard.css',
          hasFonts: true
        }],
  ...
  var renderUpdate = function() {
    ...
    var addCondition = function(tableColumnIds) {
    ...
    if (firstDC.type == 'column') {
      ...
      _.each(dcList, function(dc) {
        ...
        var tableColumnIds = {};
        tableColumnIds[dc.column.view.publicationGroup] = dc.column.tableColumnId;
        addCondition(tableColumnIds);
      });
