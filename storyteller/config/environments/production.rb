Rails.application.configure do
  ...
  if ENV['DISABLE_CACHE'].to_s !~ /^true$/i
    ...
    raise 'No memcached hosts are configured, please set MEMCACHED_HOSTS or MEMCACHED_CONFIG_ENDPOINT.' if memcached_hosts.blank?

    config.cache_store = :dalli_store, memcached_hosts, { :namespace => 'storyteller' }
  end
  ...
  # Using lograge to avoid multiline logging for sumo
