(function() {
  ...
  function columnChart($parse, $timeout, FlyoutService, I18n, PluralizeService, ColumnChartService) {
    return {
      restrict: 'E',
      scope: true,
      ...
      link: function(scope, element) {
        ...
        columnChartComponent = new socrata.visualizations.ColumnChart(element, columnChartConfig);
