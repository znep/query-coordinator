require 'hashie'
require_relative 'core_server/errors'
  ...
  class CurrentDomain
    ...
    class << self
      ...
      def default_widget_customization_id
        if @@current_domain[:widget_customization].nil?
          ...
          @@current_domain[:widget_customization] = Configuration.find_by_type('site_theme', true,
            self.class.cname, false).first.properties.sdp_template || false
      ...
      def strings(locale = nil)
        ...
        locale = I18n.locale unless locale.present? || I18n.locale.to_s == self.class.default_locale
