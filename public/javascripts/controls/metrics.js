(function($) {
  ...
  $.fn.metricsScreen = function(options) {
    ...
    $screen.bind('metricsChartRedraw', function() {
  ...
  $.fn.metricsTimeControl = function(options) {
    ...
    var updateDateParams = function(startDate, endDate, previousDate, $updateSlicer) {
      var sliceDepth = null;
    ...
    if (paramValues.start || paramValues.end) {
      initialRange = {
        dateStart: function() {
          return paramValues.start || defaultRange.dateStart();
        },
        dateEnd: function() {
          return paramValues.end || defaultRange.dateEnd();
        }
      };
    }
    ...
    $timeslice.daterangepicker({
      ...
      presetRanges: _.filter([
        ...
        },
        {
          ...
          dateEnd: 'today',
          datePrevious: function() {
            return Date.parse('1 week ago').moveToDayOfWeek(0, -1);
          },
          enabled: !blist.feature_flags['embetter_analytics_page']
        },
        defaultRange,
        ...
        },
        {
          ...
          dateEnd: function() {
            return Date.parse('1 week ago').moveToDayOfWeek(6, 1);
          },
          datePrevious: function() {
        ...
        },
        {
          ...
          datePrevious: function() {
            return Date.parse('2 months ago').moveToFirstDayOfMonth();
          },
          enabled: true
        }
      ], function(preset) {
    ...
    $slicer.uniform().change(function() {
