...
export const resultsChanged = (results) => ({
  type: RESULTS_CHANGED,
  results
});

export const resultVisibilityChanged = (visible) => ({
  type: RESULT_VISIBILITY_CHANGED,
  visible
});

export const resultFocusChanged = (focus) => ({
  type: RESULT_FOCUS_CHANGED,
  focus
});
