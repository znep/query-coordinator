(function($) {
  ...
  var legendPos = {
    text: $.t('screens.ds.grid_sidebar.chart.legend.position'),
    type: 'select',
    prompt: $.t('screens.ds.grid_sidebar.chart.legend.position_prompt'),
    defaultValue: 'bottom',
    name: 'displayFormat.legend',
    options: [{
      text: $.t('screens.ds.grid_sidebar.chart.legend.positions.bottom'),
      value: 'bottom'
    }, {
      text: $.t('screens.ds.grid_sidebar.chart.legend.positions.top'),
      value: 'top'
    }, {
      text: $.t('screens.ds.grid_sidebar.chart.legend.positions.right'),
      value: 'right'
    }, {
      text: $.t('screens.ds.grid_sidebar.chart.legend.positions.left'),
      value: 'left'
    }, {
      text: $.t('screens.ds.grid_sidebar.chart.legend.positions.none'),
      value: 'none'
    }]
  };
  ...
  var showLines = {
    text: $.t('screens.ds.grid_sidebar.chart.show_lines'),
    name: 'displayFormat.lineSize',
    type: 'checkbox',
    trueValue: '2',
    falseValue: '0',
    defaultValue: '2'
  ...
  var showPoints = {
    text: $.t('screens.ds.grid_sidebar.chart.show_points'),
    name: 'displayFormat.pointSize',
    type: 'checkbox',
    trueValue: '3',
    falseValue: '0',
    defaultValue: '3'
  ...
  var pieJoinAngle = {
    text: $.t('screens.ds.grid_sidebar.chart.min_angle_html'),
    name: 'displayFormat.pieJoinAngle',
    type: 'slider',
    minimum: 0,
    maximum: 15,
    defaultValue: 1,
    lineClass: 'hasIcon minAngle'
  };

  var smoothLine = {
    text: $.t('screens.ds.grid_sidebar.chart.smooth_line'),
    name: 'displayFormat.smoothLine',
    type: 'checkbox',
    defaultValue: false
  };


  var advLegend = function() {
    return {
      onlyIf: {
        func: function() {
          return false;
  ...
  if (isNextGen) {
    advLegend = function(chart, options) {
      ...
      if (needsValues) {
        fields.push({
          text: $.t('screens.ds.grid_sidebar.chart.legend.values'),
          type: 'checkbox',
          inputFirst: true,
          name: 'displayFormat.legendDetails.showValues',
          defaultValue: true,
      ...
      if (needsSeries) {
        fields.push({
          text: $.t('screens.ds.grid_sidebar.chart.legend.series'),
          type: 'checkbox',
          inputFirst: true,
          name: 'displayFormat.legendDetails.showSeries',
          defaultValue: true,
          lineClass: 'advLegendCheck'
        });
      }
      ...
      if (needsConditional) {
        fields.push({
          text: $.t('screens.ds.grid_sidebar.chart.legend.conditional_formats'),
          type: 'checkbox',
          inputFirst: true,
          name: 'displayFormat.legendDetails.showConditional',
          defaultValue: false,
          lineClass: 'advLegendCheck'
        });
      }
      ...
      if (needsValueMarkers) {
        fields.push({
          text: $.t('screens.ds.grid_sidebar.chart.legend.annotations'),
          type: 'checkbox',
          inputFirst: true,
          name: 'displayFormat.legendDetails.showValueMarkers',
          defaultValue: true,
          lineClass: 'advLegendCheck'
        });
      }
      ...
      if (needsCustom) {
        fields.push({
          ...
          addText: $.t('screens.ds.grid_sidebar.chart.legend.add_text_button'),
          name: 'displayFormat.legendDetails.customEntries',
          prompt: $.t('screens.ds.grid_sidebar.chart.axes.x_axis_title_prompt'),
          field: {
            type: 'group',
            options: [{
              type: 'color',
              ...
              text: $.t('screens.ds.grid_sidebar.chart.legend.add_text'),
              type: 'text',
              name: 'label',
              required: true
            }]
  ...
  var pointSize = function(options) {
    return {
      text: $.t('screens.ds.grid_sidebar.chart.point_size'),
      name: 'displayFormat.pointSize',
      type: 'columnSelect',
      useFieldName: true,
      lineClass: 'hasIcon pointSize',
      columns: {
  ...
  var pointColor = function(options) {
    return {
      text: $.t('screens.ds.grid_sidebar.chart.point_color'),
      name: 'displayFormat.pointColor',
      type: 'columnSelect',
      useFieldName: true,
      lineClass: 'hasIcon pointColor',
      columns: {
        type: ['number', 'money', 'percent'],
        hidden: options.isEdit
      }
  ...
  var baseColor = {
    text: $.t('screens.ds.grid_sidebar.chart.base_color'),
    name: 'displayFormat.color',
    type: 'color',
    defaultValue: '#042656'
  };

  var dataLabels = {
    text: $.t('screens.ds.grid_sidebar.chart.data_labels'),
    name: 'displayFormat.dataLabels',
    type: 'checkbox'
  };

  var treemapRandomColorWarning = {
    type: 'note',
  ...
  var valueMarker = function(chart, options) {
    return subheading(chart, options, $.t('screens.ds.grid_sidebar.chart.marker.title'), [{
      type: 'repeater',
      name: 'displayFormat.valueMarker',
      addText: $.t('screens.ds.grid_sidebar.chart.marker.add_button'),
      minimum: 0,
      initialRepeatCount: 0,
      lineClass: 'hasIcon valueMarker',
      field: {
        type: 'group',
        options: [{
          type: 'group',
          options: [{
            ...
            text: $.t('screens.ds.grid_sidebar.chart.marker.value'),
            type: 'text',
            name: 'atValue'
          }]
        }, {
          text: $.t('screens.ds.grid_sidebar.chart.marker.caption'),
          type: 'text',
          name: 'caption'
        }]
      }
  ...
  var showPercentages = {
    type: 'checkbox',
    name: 'displayFormat.showPercentages',
    text: $.t('screens.ds.grid_sidebar.chart.show_percent'),
    inputFirst: true,
    lineClass: 'indentedFormSection'
  };
  var showActualValues = {
    type: 'checkbox',
    name: 'displayFormat.showActualValues',
    text: $.t('screens.ds.grid_sidebar.chart.show_values'),
    inputFirst: true,
    lineClass: 'indentedFormSection'
  };

  var labelInBar = {
    text: $.t('screens.ds.grid_sidebar.chart.labelInBar'),
    type: 'checkbox',
    name: 'displayFormat.xAxis.labelInBar',
    lineClass: 'hasIcon labelInBar',
    inputFirst: true
  };

  var valueInBar = {
    text: $.t('screens.ds.grid_sidebar.chart.valueInBar'),
    type: 'checkbox',
    name: 'displayFormat.xAxis.valueInBar',
    lineClass: 'hasIcon valueInBar',
    inputFirst: true
  };
    ...
    _.each(newTypes, function(rc) {
      ...
      if (rc == newTypes[0]) {
        ...
        result.push({
          tagName: 'span',
          'class': 'title',
          contents: $.t('screens.ds.grid_sidebar.chart.validation.chart_requires', {
              chart_type: chartName.capitalize()
            }) +
            $.t('screens.ds.grid_sidebar.chart.validation.chart_requires2', {
              and: and,
              count: count
            })
        });
        ...
        result.push({
          tagName: 'span',
          'class': 'title',
          contents: $.t('screens.ds.grid_sidebar.chart.validation.chart_requires2', {
            and: and,
            count: count
          })
        });
      }
      _.each(rc.types, function(type) {
        result.push({
          tagName: 'div',
          'class': blist.datatypes[type].name + ' flyoutIcon',
          contents: [{
            tagName: 'span',
            'class': 'blist-th-icon'
          }, {
            tagName: 'span',
            contents: $.t('screens.ds.grid_sidebar.base.datatypes.' +
              transform(blist.datatypes[type].title).toLowerCase()).capitalize()
          }]
        });
      });
    });
  ...
  var subheading = function(chart, options, sectionTitle, content, show) {
    return {
      title: sectionTitle,
      type: 'selectable',
      customClasses: 'sectionSubheading',
      fields: content,
  ...
  var dataSelection = function(chart, options, categoryColTypes, valueColTypes, axisName) {
    var selectionConfig = subheading(chart, options, $.t('screens.ds.grid_sidebar.chart.data_selection.chart_definition.title'), [{
      text: axisName,
      name: 'displayFormat.fixedColumns.0',
      lineClass: 'hasIcon ' + chart.value + 'LabelSelection',
      type: 'columnSelect',
      required: true,
      useFieldName: true,
      notequalto: 'valueCol',
      columns: {
        type: categoryColTypes,
        hidden: options.isEdit
      }
    }, {
      type: 'repeater',
      minimum: 1,
      addText: $.t('screens.ds.grid_sidebar.chart.data_columns.new_data_column_button'),
      name: 'displayFormat.valueColumns',
      lineClass: 'hasIcon ' + chart.value + 'ValueSelection',
      field: {
        required: true,
        type: 'columnSelect',
  ...
  var advancedDataSelection = function(chart, options, colTypes) {
    ...
    var tooManyRows = isNextGen && _.any(options.view.realColumns,
      function(col) {
        return $.deepGet(col, 'cachedContents', 'non_null') > 10000;
      });
    ...
    var result = subheading(chart, options, $.t('screens.ds.grid_sidebar.chart.data_selection.advanced_data_selection.title'), [
      ...
      {
        type: 'group',
        extraClass: 'subsection dsg',
        options: [{
          type: 'note',
          value: $.t('screens.ds.grid_sidebar.chart.series_group.title')
        }, {
          type: 'note',
          value: $.t('screens.ds.grid_sidebar.chart.series_group.row_limit_warning'),
          onlyIf: tooManyRows,
          lineClass: 'flash notice'
        }, {
          type: 'repeater',
          minimum: 1,
          addText: $.t('screens.ds.grid_sidebar.chart.series_group.new_column_button'),
          lineClass: 'dataSeriesGrouping',
          name: 'displayFormat.seriesColumns',
          field: {
            text: $.t('screens.ds.grid_sidebar.chart.series_group.group_by'),
            type: 'columnSelect',
            notequalto: 'valueCol',
            useFieldName: true,
            name: 'fieldName',
          ...
          type: 'checkbox',
          text: $.t('screens.ds.grid_sidebar.chart.series_group.alphabetize'),
          name: 'displayFormat.sortSeries',
          inputFirst: true,
          lineClass: 'indentedFormSection'
        }, {
          type: 'checkbox',
          text: $.t('screens.ds.grid_sidebar.chart.series_group.hideLoadingMsg'),
    ...
    if (chart.value != 'line' && chart.value != 'area' && chart.value != 'timeline') {
      ...
      result.fields = result.fields.concat(
        [{
          type: 'group',
          extraClass: 'subsection errorBars',
          options: [{
            type: 'note',
            value: $.t('screens.ds.grid_sidebar.chart.error_bars.title')
          }, {
            text: $.t('screens.ds.grid_sidebar.chart.error_bars.color'),
            name: 'displayFormat.errorBarColor',
            type: 'color',
            defaultValue: '#ff0000',
            lineClass: 'hasIcon errorBar'
          }, {
            text: $.t('screens.ds.grid_sidebar.chart.error_bars.data_low'),
            name: 'displayFormat.plot.errorBarLow',
            type: 'columnSelect',
            useFieldName: true,
            notequalto: 'errorBar',
            columns: {
              type: Dataset.chart.numericTypes,
              hidden: options.isEdit
            }
          }, {
            text: $.t('screens.ds.grid_sidebar.chart.error_bars.data_high'),
            name: 'displayFormat.plot.errorBarHigh',
            type: 'columnSelect',
            useFieldName: true,
            notequalto: 'errorBar',
            columns: {
  ...
  var colors = function(chart, options) {
    ...
    if (chart.value == 'bubble') {
      ...
      result.fields.push({
        type: 'repeater',
        text: $.t('screens.ds.grid_sidebar.chart.colors'),
        field: $.extend({}, colorOption, {
          name: ''
        }),
        name: 'displayFormat.colors',
        minimum: 1,
        initialRepeatCount: 5,
    ...
    if (!_.contains(['bubble', 'donut', 'treemap', 'pie'], chart.value)) {
      ...
      result.fields.push({
        text: $.t('screens.ds.grid_sidebar.chart.color_options.column_colors'),
        type: 'custom',
        linkedField: ['displayFormat.valueColumns'],
        name: 'displayFormat.valueColumns',
        lineClass: 'colors',
        editorCallbacks: {
          create: function($field, val) {
            ...
            _.each(val, function(col, i) {
              ...
              colorGroup.contents.push({
                tagName: 'div',
                'class': 'columnColorControl',
                'data-colorpicker-color': assignedColor
              }, {
                tagName: 'div',
                contents: readableName
              });
          ...
          value: function($field) {
            ...
            $field.find('.columnColorControl').each(
              function(index, cs) {
                result.push({
                  color: $(cs).data('colorpicker-color')
                });
              });
            return result;
          }
    ...
    result.fields.push({
      type: 'note',
      value: $.t('screens.ds.grid_sidebar.chart.cdlfmtg_color_override_html'),
      lineClass: 'conditionalFormattingWarning notice flash'
    });
  ...
  var flyoutConfig = function(chart, options) {
    return subheading(chart, options, $.t('screens.ds.grid_sidebar.chart.flyout.title'), [{
        ...
        name: 'displayFormat.titleFlyout',
        otherNames: 'tableColumnId',
        onlyIf: {
          field: 'displayFormat.pointSize',
          value: '0',
          negate: true
        },
        type: 'columnSelect',
...

      {
        ...
        field: {
          type: 'group',
          options: [{
            text: $.t('screens.ds.grid_sidebar.chart.flyout.value'),
            name: 'fieldName',
            otherNames: 'tableColumnId',
            type: 'columnSelect',
            useFieldName: true,
        ...
        minimum: 1,
        addText: $.t('screens.ds.grid_sidebar.chart.flyout.new_values_button')
      }
    ]);
  };
  ...
  var axisOptions = function(chart, options) {
    var result = subheading(chart, options, $.t('screens.ds.grid_sidebar.chart.axes.title'), [{
        text: $.t('screens.ds.grid_sidebar.chart.axes.x_axis_title'),
        name: 'displayFormat.titleX',
        type: 'text',
        prompt: $.t('screens.ds.grid_sidebar.chart.axes.x_axis_title_prompt')
      }, {
        text: $.t('screens.ds.grid_sidebar.chart.axes.y_axis_title'),
        name: 'displayFormat.titleY',
        type: 'text',
        prompt: $.t('screens.ds.grid_sidebar.chart.axes.y_axis_title_prompt')
      }, {
        text: $.t('screens.ds.grid_sidebar.chart.y_axis_formatting.axis_min'),
        type: 'radioGroup',
        defaultValue: 'yAxisMinAuto',
        name: 'yAxisMin',
        options: [{
          type: 'static',
          name: 'yAxisMinAuto',
          value: $.t('screens.ds.grid_sidebar.chart.y_axis_formatting.auto')
        }, {
          type: 'text',
          name: 'displayFormat.yAxis.min',
          prompt: $.t('screens.ds.grid_sidebar.chart.y_axis_formatting.axis_prompt'),
          extraClass: 'number'
        }]
      }, {
        text: $.t('screens.ds.grid_sidebar.chart.y_axis_formatting.axis_max'),
        type: 'radioGroup',
        defaultValue: 'yAxisMaxAuto',
        name: 'yAxisMax',
        options: [{
          type: 'static',
          name: 'yAxisMaxAuto',
          ...
          type: 'text',
          name: 'displayFormat.yAxis.max',
          prompt: $.t('screens.ds.grid_sidebar.chart.y_axis_formatting.axis_prompt'),
          extraClass: 'number'
        }]
      },
      isNextGen ? {
        text: $.t('screens.ds.grid_sidebar.chart.y_axis_formatting.decimals'),
        type: 'radioGroup',
        ...
        text: $.t('screens.ds.grid_sidebar.chart.y_axis_formatting.precision'),
        type: 'text',
        spinner: true,
        minimum: 0,
        maximum: 10,
        ...
        text: $.t('screens.ds.grid_sidebar.chart.y_axis_formatting.abbreviate'),
        type: 'checkbox',
        defaultValue: true,
  ...
  var dataSelectionBubble = function(chart, options) {
    return subheading(chart, options, $.t('screens.ds.grid_sidebar.chart.data_columns.title'), [{
        ...
        name: 'displayFormat.fixedColumns.0',
        lineClass: 'hasIcon bubbleLabelSelection',
        type: 'columnSelect',
        required: false,
        useFieldName: true,
        notequalto: 'valueCol',
        columns: {
          type: Dataset.chart.textualTypes,
          hidden: options.isEdit
        }
      }, {
        text: $.t('screens.ds.grid_sidebar.chart.data_selection.chart_definition.value_title'),
        ...
        useFieldName: true,
        notequalto: 'valueCol',
        lineClass: 'hasIcon bubbleValueSelection',
  ...
  var getPieDefaultOrderBy = function(options) {
    ...
    return _.compact(_.map(view.displayFormat.valueColumns, function(col) {
      col = view.columnForIdentifier(col.fieldName || col.tableColumnId);
  ...
  var autoSortButtonInfo = function(options, chartType) {
    return {
      ...
      onlyIf: {
        func: function() {
          return shouldEnableAutoPieSortButton(options);
        }
      },
  ...
  var dataSelectionPie = function(options) {
    ...
    bc.fields.push({
      ...
      name: 'displayFormat.valueColumns.0.fieldName',
      otherNames: 'displayFormat.valueColumns.0.tableColumnId',
      lineClass: 'hasIcon pieValueSelection',
      notequalto: 'valueCol',
      type: 'columnSelect',
      required: true,
      useFieldName: true,
      ...
      case 'treemap':
        ...
        result.push(
          ...
          subheading(chart, options, $.t('screens.ds.grid_sidebar.chart.configuration'), [{
            ...
            required: true,
            useFieldName: true,
            lineClass: 'hasIcon treemapLabelSelection',
            columns: {
              type: Dataset.chart.textualTypes,
              hidden: options.isEdit
            }
            ...
            name: 'displayFormat.valueColumns.0.fieldName',
            otherNames: 'displayFormat.valueColumns.0.tableColumnId',
            lineClass: 'hasIcon treemapValueSelection',
            notequalto: 'valueCol',
            type: 'columnSelect',
            required: true,
            useFieldName: true,
