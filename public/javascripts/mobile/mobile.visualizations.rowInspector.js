(function(root) {
  ...
  var _$showMoreContent;
  var _$showMoreButton;
  ...
  function rowInspectorSetup(config) {
    ...
    _$showMoreContent = _$rowInspectorContainer.find('.show-more');
    _$showMoreButton = _$rowInspectorContainer.find('.show-more-button');
  ...
  var _attachEventsOnce = _.once(function() {
    ...
    _$showMoreButton.on('click', _captureShowMoreClick);
  });
  ...
  function _captureShowMoreClick(event) {
    _$showMoreButton.toggleClass('active');
    _$rowInspectorContainer.find('.tool-panel-main').toggleClass('expand');
  }
  ...
  function _render() {
    ...
    // Conditionally show the show more button
    _$showMoreContent.toggleClass('hidden', !hasRows);
