...
ActiveRecord::Schema.define(version: 20150615204044) do
  ...
  create_table "draft_stories", id: false, force: :cascade do |t|
    t.integer  "draft_story_id"
  ...
  add_index "draft_stories", ["id"], name: "index_draft_stories_on_id", using: :btree

  create_table "published_stories", id: false, force: :cascade do |t|
  ...
  add_index "published_stories", ["id"], name: "index_published_stories_on_id", using: :btree
