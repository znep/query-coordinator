var visualisations = require('socrata-visualizations');
var MetadataProvider = visualisations.dataProviders.MetadataProvider;
...
module.exports = function(values, $target) {
  ...
  function renderTable(displayableColumns) {
    var tableVIF = {
      'aggregation': {
        'columnName': null,
        'function': 'count'
      ...
      'configuration': {
        ...
        'order': [{
          ascending: true,
          columnName: displayableColumns[0].fieldName,
        }]
      },
  ...
  .then(metadataProvider.getDisplayableColumns)
  .then(renderTable);
};
