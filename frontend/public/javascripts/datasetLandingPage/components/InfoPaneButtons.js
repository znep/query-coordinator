...
import ApiFlyout from './ApiFlyout';
import ShareFlyout from './ShareFlyout';
...
export default class InfoPaneButtons extends Component {
  ...
  renderMoreActions() {
    ...
    const shouldApiLinkRender = isMobile || isTablet;
    let apiLink = null;
    if (shouldApiLinkRender && !isBlobbyOrHref) {
      apiLink = (
        <li>
  ...
  render() {
    return (
      <div className="btn-group">
        ...
        <DownloadFlyout {...this.props} />
        <ApiFlyout {...this.props} />
        <ShareFlyout {...this.props} />
