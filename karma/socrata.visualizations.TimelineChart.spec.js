describe('socrata.visualizations.TimelineChart', function() {
  'use strict';
  ...
  beforeEach(function() {
    ...
    allLabelsTestData = unpickleTestData(window.timelineChartTestData.allLabelsTimelineChartTestData, false);
    filteredTestData = unpickleTestData(window.timelineChartTestData.testData, true);
    hiddenLabelTestData = unpickleTestData(window.timelineChartTestData.hiddenLabelTimelineChartTestData, false);
    negativeTestData = unpickleTestData(window.timelineChartTestData.negativeTestData, false);
    nonContinuousTestData = unpickleTestData(window.timelineChartTestData.nonContinuousTestData, false);
    noDataData = unpickleTestData(window.timelineChartTestData.noData, false);
    allDataAtSameTimestampData = unpickleTestData(window.timelineChartTestData.allDataAtSomeTimestamp, false);
  });
  ...
  function createTimelineChart(width, expanded, data, precision) {
    ...
    var chart = new window.socrata.visualizations.TimelineChart(element, timelineChartVIF);
  ...
  xit('should not create a selection when the mouse is clicked on the third y tick', function() {
    var chart = createTimelineChart(640, false);
