...
$(function() {
  ...
  var downloadsSummary = {
    id: 'summaryDownloads',
    displayName: $.capitalize(t('downloads')),
    summary: {
      plus: downloadsAction,
      verbPhrase: t('downloads'),
  ...
  if (blist.dataset.viewType == 'tabular') {
    ...
    summaries = [
      ...
      downloadsSummary, {
        id: 'summaryEmbeds',
        displayName: $.capitalize(t('embeds')),
        summary: {
          plus: 'embeds',
          verbPhrase: t('embeds'),
    ...
    details = [{
      id: 'detailMetricsUsing',
      displayName: t('dependent_metrics'),
      summary: {
      ...
      id: 'detailTotalComputes',
      displayName: t('total_govstat_hits'),
      summary: {
  ...
  var screen = $('#analyticsDataContainer').metricsScreen($.extend({
    ...
    detailSections: _.filter(details, function(section) {
      return section.enabled !== false;
    }),
    summarySections: _.filter(summaries, function(section) {
      return section.enabled !== false;
    }),
    topListSections: _.filter(topLists, function(section) {
      return section.enabled !== false;
    })
