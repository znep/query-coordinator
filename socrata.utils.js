(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    // Ensure the window.socrata and window.socrata.utils objects exist, then
    // use that as the exports object. Our exports is nested inside the socrata
    // namespace, so we have to do this here rather than in the factory body
    // (otherwise we'd have to do `require('socrata-utils').utils.assert`).
    root.socrata = root.socrata || {};
    root.socrata.utils = root.socrata.utils || {};
    factory(root.socrata.utils, root._);
  }
  ...
  // Decorate exports with basic utility functions.
  _.merge(exports, socrataUtils);
