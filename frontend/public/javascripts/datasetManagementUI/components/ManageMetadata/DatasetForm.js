...
// The user-defined validation schema that we will pass to the validateSchema HOC.
// Check the validateSchema component for built-in validations you can use and how to
