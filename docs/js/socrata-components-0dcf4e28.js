(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("tether-shepherd"), require("react"));
	else if(typeof define === 'function' && define.amd)
		define(["tether-shepherd", "react"], factory);
	else if(typeof exports === 'object')
		exports["styleguide"] = factory(require("tether-shepherd"), require("react"));
	else
		root["styleguide"] = factory(root["Shepherd"], root["React"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_10__, __WEBPACK_EXTERNAL_MODULE_13__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Dropdown3 = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  ...
	  onClickBucket: function onClickBucket(color) {
	    this.setState({
	      showingBuckets: false,
	      selectedColor: color
	    });
	  ...
	  render: function render() {
	    ...
	    var colorBuckets = palette.map(function (color, key) {
	      var isSelectedColor = color === selectedColor;
	      var style = { backgroundColor: color };
	      var attributes = {
	        key: key,
	        className: (0, _classnames2.default)('color-bucket', { 'selected-color': isSelectedColor }),
	        style: style,
	        onClick: _this.onClickBucket.bind(_this, color)
	      };
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: 'color-picker', id: id },
	      _react2.default.createElement('div', { className: colorOverlayClassName, onClick: this.onClose }),
	      _react2.default.createElement(
	        'div',
	        { className: 'color-frame', onClick: this.onClickColorFrame },
	        _react2.default.createElement('div', { className: 'selected-color-frame', style: colorFrameStyle }),
	        _react2.default.createElement(
	          'div',
	          { className: 'caret' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  ...
	  onMouseOverOptions: function onMouseOverOptions() {
	  ...
	  onClickOption: function onClickOption(selectedOption, event) {
	    ...
	    this.setState({ selectedOption: selectedOption, opened: false });
	  },
	  onMouseDownOption: function onMouseDownOption(event) {
	    event.preventDefault();
	  },
	  moveToNextOption: function moveToNextOption() {
	    var options = this.props.options;
	    var highlightedOption = this.state.highlightedOption;
	
	    var hasHighlightedOption = highlightedOption === null;
	    var previousOption = hasHighlightedOption ? 0 : Math.min(highlightedOption + 1, options.length - 1);
	
	    this.setState({ opened: true, highlightedOption: previousOption });
	  },
	  moveToPreviousOption: function moveToPreviousOption() {
	    var highlightedOption = this.state.highlightedOption;
	
	    var hasHighlightedOption = highlightedOption === null;
	    var nextOption = hasHighlightedOption ? 0 : Math.max(highlightedOption - 1, 0);
	  ...
	  selectOption: function selectOption() {
	    ...
	    var highlightedOption = _state.highlightedOption;
	
	
	    if (opened && highlightedOption !== null) {
	      var options = this.props.options;
	
	      var selectedOption = options[highlightedOption];
	  ...
	  renderOptions: function renderOptions() {
	    ...
	    var displayTrueWidthOptions = _props2.displayTrueWidthOptions;
	
	
	    var classes = (0, _classnames2.default)('dropdown-options-list', {
	    ...
	    var attributes = {
	      ...
	      ref: function ref(_ref) {
	        return _this.options = _ref;
	      }
	    };
	
	    var header = function header(groupName, key) {
	      return _react2.default.createElement(
	        'div',
	        { className: 'dropdown-options-group-header', key: key },
	        groupName
	      );
	    };
	
	    var separator = function separator(key) {
	      return _react2.default.createElement('div', { className: 'dropdown-options-separator', key: key });
	    };
	
	    options.forEach(function (option, index) {
	      var previousOption = options[index - 1];
	      var differentGroup = previousOption && previousOption.group !== option.group;
	  ...
	  renderOption: function renderOption(option, index) {
	    ...
	    var highlightedOption = _state2.highlightedOption;
	
	    var hasRenderFunction = typeof option.render === 'function';
	    var onClickOptionBound = this.onClickOption.bind(this, option);
	    var classes = (0, _classnames2.default)('dropdown-option', {
	    ...
	    var content = hasRenderFunction ? option.render(option) : _react2.default.createElement(
	      'span',
	      { className: 'dropdown-option-title', key: index },
	      option.title
	    );
	  ...
	  render: function render() {
	    ...
	    var classes = (0, _classnames2.default)('dropdown-container', {
	    ...
	    return _react2.default.createElement(
	      'div',
	      _extends({ className: classes, ref: reference }, this.props),
	      placeholder,
	      options
	    );
	  }
...
;
//# sourceMappingURL=socrata-components.js-6c5fe879.map