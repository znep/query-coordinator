...
export const edit_dashboards = 'edit_dashboards';
...
export const create_story_copy = 'create_story_copy';
export const edit_nominations = 'edit_nominations';
export const edit_site_theme = 'edit_site_theme';
export const edit_story_title_desc = 'edit_story_title_desc';
...
export const manage_story_visibility = 'manage_story_visibility';
...
export const view_goals = 'view_goals';
export const view_others_datasets = 'view_others_datasets';
export const view_story = 'view_story';
export const view_unpublished_story = 'view_unpublished_story';
