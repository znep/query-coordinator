  ...
  function render() {
    ...
    if ($.cf.configuration().canAdd) {
      if (blist.configuration.govStat) {
        ...
        var t = function(name) {
          return $.t('govstat.reports.component.' + name);
        };
        $.cf.edit.addComponentPalette('Report', [{
          typeName: 'Header',
          catalogName: t('header')
        }, {
          typeName: 'Title',
          catalogName: t('title')
        }, {
          typeName: 'FormattedText',
          catalogName: t('formatted_text')
        }, {
          typeName: 'Picture',
          catalogName: t('picture')
        }, {
          typeName: 'Print',
          catalogName: t('print')
        }, {
        ...
        $.cf.edit.addComponentPalette('Advanced', [{
          typeName: 'Container',
          catalogName: t('vertical_layout'),
          icon: 'VerticalContainer'
        }, {
          typeName: 'HorizontalContainer',
          catalogName: t('horizontal_layout'),
          icon: 'HorizontalContainer'
        }, {
          typeName: 'Visualization',
          catalogName: t('visualize'),
          icon: 'Visualization'
        }, {
          typeName: 'Map',
          catalogName: t('base_map')
        }, {
          typeName: 'MapLayer',
          catalogName: t('map_layer')
        ...
        _.each([$.component.catalog.content, $.component.catalog.data, $.component.catalog.actions,
          ...
          if (!_.isEmpty(comps)) {
            $.cf.edit.addComponentPalette(section.name, comps, i + 1);
          }
        });
      }
    }
