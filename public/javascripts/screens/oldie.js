$(function() {
  ...
  $.tag({
    tagName: 'div',
    'class': 'modalDialog noIeModal',
    contents: [{
      tagName: 'h2',
      contents: 'Outdated Browser Detected'
    }, {
      tagName: 'p',
      'class': 'modalParagraph',
      contents: 'Socrata.com uses the latest in Web technologies to bring you ' +
      ...
      contents: [{
        tagName: 'a',
        'class': 'button default jqmClose',
        href: '#',
        contents: 'Got it'
      }, {
        tagName: 'a',
        'class': 'button',
        href: 'http://update.microsoft.com',
