...
describe('TimeDataManager', () => {
  let getPrecisionBySeriesIndex;
  let revertTimeDataManagerAPI;

  beforeEach(() => {
    getPrecisionBySeriesIndex = TimeDataManagerAPI.__get__(
      'getPrecisionBySeriesIndex'
    );
    revertTimeDataManagerAPI = TimeDataManagerAPI.__set__({
  ...
  describe('getPrecisionBySeriesIndex()', () => {
    ...
    it('does not compute a precision when the precision property in the vif is recognized', () => {
      ...
      return getPrecisionBySeriesIndex(vif, 0).
        then((precision) => {
