describe('SocrataFeatureMap component', function() {
  ...
  describe('constructor', function() {
    ...
    describe('given valid arguments', function() {
      ...
      var actualTileserverDataProvider;
      var actualMetadataProvider;
      ...
      beforeEach(function() {
        ...
        // Mock TileServerDataprovider
        actualTileserverDataProvider = window.socrata.visualizations.TileserverDataProvider;
        window.socrata.visualizations.TileserverDataProvider = function() {
        ...
        actualMetadataProvider = window.socrata.visualizations.MetadataProvider;
        window.socrata.visualizations.MetadataProvider = function() {
      ...
      afterEach(function() {
        ...
        window.socrata.visualizations.TileserverDataProvider = actualTileserverDataProvider;
