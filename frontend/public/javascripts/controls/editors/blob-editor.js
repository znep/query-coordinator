(function($) {
  var tt = function(str) {
    return $.t('controls.editors.document.' + str + '_title');
  };
  var ta = function(str) {
    return $.t('controls.editors.actions.' + str);
  };
