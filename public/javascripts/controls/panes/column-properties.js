(function($) {
  ...
  var convertTypes = function(c) {
    ...
    var t = col.dataType;
    var types = [{
      text: $.t('core.data_types.' + col.renderTypeName),
      value: col.renderTypeName
    }];
    return types.concat(_.chain(t.convertableTypes || []).reject(function(ct) {
      return disableLegacyTypes && blist.datatypes[ct].deprecatedInNbe;
    }).sortBy(function(ct) {
      return blist.datatypes[ct].priority;
    }).map(function(ct) {
      return {
        value: ct,
        text: $.t('core.data_types.' + ct)
      };
    }).value());
  };
  ...
  var aggregateOptions = function(c) {
    if ($.isBlank(c) || _.isEmpty(c.origColumn.renderType.aggregates)) {
      return 'hidden';
    }
    return _.map(c.origColumn.renderType.aggregates, function(a) {
      return $.extend({}, a, {
        value: blist.datatypes.aggregateFromSoda2(a.value)
      });
    });
  };
  ...
  var viewOptions = function(c) {
    ...
    if (_.include(['date', 'calendar_date'], col.renderTypeName)) {
      ...
      vt = _.map(vt, function(t) {
        return {
          text: today.format(type.formats[t.value]),
          value: t.value
        };
      });
    }
  ...
  var currencyOptions = _.map([
    ...
    // Now all the currencies that no one ever uses...
    {
      ...
      value: 'AZN',
      text: 'Azerbaijan, New Manats'
    }, {
      value: 'BSD',
      text: 'Bahamas, Dollars'
    }, {
      value: 'BBD',
      text: 'Barbados, Dollars'
    }, {
      value: 'BYR',
      text: 'Belarus, Rubles'
    }, {
      ...
      value: 'BMD',
      text: 'Bermuda, Dollars'
    }, {
      value: 'BOB',
      text: 'Bolivia, Bolivianos'
    }, {
      value: 'BAM',
      ...
      value: 'CRC',
      text: 'Costa Rica, Colones'
    }, {
      value: 'HRK',
      text: 'Croatia, Kuna'
    }, {
      value: 'CZK',
      text: 'Czech Republic, Koruny'
    }, {
      value: 'DKK',
      text: 'Denmark, Kroner'
    }, {
      value: 'DOP',
      text: 'Dominican Republic, Pesos'
    }, {
      value: 'EGP',
      text: 'Egypt, Pounds'
    }, {
      ...
      value: 'IDR',
      text: 'Indonesia, Rupiahs'
    }, {
      value: 'IRR',
      text: 'Iran, Rials'
    }, {
      value: 'ILS',
      text: 'Israel, New Shekels'
    }, {
      value: 'JMD',
      text: 'Jamaica, Dollars'
    }, {
      value: 'JPY',
      text: 'Japanese Yen'
    }, {
      ...
      value: 'LRD',
      text: 'Liberia, Dollars'
    }, {
      value: 'LTL',
      text: 'Lithuania, Litai'
    }, {
      value: 'MKD',
      text: 'Macedonia, Denars'
    }, {
      value: 'MYR',
      text: 'Malaysia, Ringgits'
    }, {
      value: 'MXN',
      text: 'Mexico, Pesos'
    }, {
      value: 'MNT',
      text: 'Mongolia, Tugriks'
    }, {
      value: 'MZN',
      text: 'Mozambique, Meticais'
    }, {
      value: 'NAD',
      text: 'Namibia, Dollars'
    }, {
      value: 'NPR',
      text: 'Nepal, Nepal Rupees'
    }, {
      value: 'NZD',
      text: 'New Zealand, Dollar'
    }, {
      value: 'NIO',
      text: 'Nicaragua, Cordobas'
    }, {
      value: 'NGN',
      text: 'Nigeria, Nairas'
    }, {
      ...
      value: 'PEN',
      text: 'Peru, Nuevos Soles'
    }, {
      value: 'PHP',
      text: 'Philippines, Pesos'
    }, {
      value: 'PLN',
      text: 'Poland, Klotych'
    }, {
      ...
      value: 'RON',
      text: 'Romania, New Lei'
    }, {
      value: 'SAR',
      text: 'Saudi Arabia, Riyals'
    }, {
      value: 'RSD',
      text: 'Serbia, Dinars'
    }, {
      ...
      value: 'SOS',
      text: 'Somalia, Shillings'
    }, {
      value: 'ZAR',
      text: 'South Africa, Rand'
    }, {
      value: 'LKR',
      text: 'Sri Lanka, Rupees'
    }, {
      value: 'SEK',
      text: 'Sweden, Kronor'
    }, {
      ...
      value: 'TWD',
      text: 'Taiwan, New Dollars'
    }, {
      value: 'THB',
      text: 'Thailand, Baht'
    }, {
      value: 'TRY',
      text: 'Turkey, New Lira'
    }, {
      value: 'UAH',
      ...
      value: 'UZS',
      text: 'Uzbekistan, Sums'
    }, {
      value: 'VEF',
      text: 'Venezuela, Bolivares Fuertes'
    }, {
      value: 'VND',
      text: 'Vietnam, Dong'
    }, {
    ...
    _dataPreProcess: function(col) {
      ...
      if (!$.isBlank(col.format) && !$.isBlank(col.format.rdf)) {
        ...
        _.forEach(rdfProps, function(r) {
          if (_.any(rdfOptions, function(stockR) {
              return stockR.value == r;
            })) {
            cleanCol.format.rdf.push({
              stock: r
            });
          } else {
            cleanCol.format.rdf.push({
    ...
    _getSections: function() {
      ...
      return [{
        ...
        // Link Column
        {
          ...
          onlyIf: {
            func: showLinkSection
          },
          fields: [{
            text: $.t('screens.ds.grid_sidebar.column_properties.link.key'),
            type: 'columnSelect',
            ...
            text: $.t('screens.ds.grid_sidebar.column_properties.link.source'),
            type: 'select',
...

        {
          ...
          fields: [{
            text: $.t('screens.ds.grid_sidebar.column_properties.formatting.alignment'),
            type: 'select',
            name: 'format.align',
            prompt: null,
...

        {
          ...
          fields: [{
            text: $.t('screens.ds.grid_sidebar.column_properties.text_formatting.display_style'),
            type: 'select',
            name: 'format.displayStyle',
            prompt: null,
        ...
        // Number-specific info
        {
          ...
          fields: [{
            text: $.t('screens.ds.grid_sidebar.column_properties.number.precision'),
            type: 'radioGroup',
            name: 'precisionGroup',
            defaultValue: 'format.precisionNone',
            options: [{
              type: 'static',
              value: $.t('screens.ds.grid_sidebar.column_properties.number.no_precision'),
            ...
            text: $.t('screens.ds.grid_sidebar.column_properties.number.display'),
            type: 'select',
            name: 'format.precisionStyle',
            prompt: null,
            ...
            text: $.t('screens.ds.grid_sidebar.column_properties.number.no_commas'),
            type: 'checkbox',
            name: 'format.noCommas'
          }]
        },

        {
          ...
          fields: [{
            text: $.t('screens.ds.grid_sidebar.column_properties.number_advanced.format_mask'),
            type: 'text',
            name: 'format.mask'
          }, {
            type: 'note',
            value: $.t('screens.ds.grid_sidebar.column_properties.number_advanced.format_mask_prompt')
          }, {
            type: 'note',
            value: $.t('screens.ds.grid_sidebar.column_properties.number_advanced.format_mask_warning')
          }]
        },
        ...
        // Money-specific styles
        {
          ...
          fields: [{
            text: $.t('screens.ds.grid_sidebar.column_properties.money.precision'),
            type: 'radioGroup',
            name: 'moneyPrecisionGroup',
            defaultValue: 'format.precisionNone',
            options: [{
              type: 'static',
              value: $.t('screens.ds.grid_sidebar.column_properties.money.no_precision'),
              name: 'format.precisionNone'
            }, {
              type: 'slider',
              minimum: 0,
            ...
            text: $.t('screens.ds.grid_sidebar.column_properties.money.abbreviated'),
            type: 'checkbox',
            name: 'format.humane'
          }]
        },
        ...
        // Number localization
        {
          title: $.t('screens.ds.grid_sidebar.column_properties.localization.title'),
          type: 'selectable',
          showIfData: true,
          onlyIf: {
            func: function(c) {
          ...
          fields: [{
            text: $.t('screens.ds.grid_sidebar.column_properties.localization.decimal'),
            type: 'text',
            name: 'format.decimalSeparator',
            defaultValue: '.'
          }, {
            text: $.t('screens.ds.grid_sidebar.column_properties.localization.thousands'),
            type: 'text',
            name: 'format.groupSeparator',
            defaultValue: ','
          }]
        },
        ...
        // Photo
        {
          ...
          fields: [{
            text: $.t('screens.ds.grid_sidebar.column_properties.photo.size'),
            type: 'select',
            name: 'format.size',
            prompt: $.t('screens.ds.grid_sidebar.column_properties.photo.size_prompt'),
            options: [{
              value: 'tiny',
              text: $.t('screens.ds.grid_sidebar.column_properties.photo.sizes.tiny')
            }, {
              value: 'thumb',
              text: $.t('screens.ds.grid_sidebar.column_properties.photo.sizes.thumb')
            }, {
              value: 'medium',
              text: $.t('screens.ds.grid_sidebar.column_properties.photo.sizes.medium')
            }, {
              value: 'featured',
              text: $.t('screens.ds.grid_sidebar.column_properties.photo.sizes.featured')
            }, {
              value: 'large',
              text: $.t('screens.ds.grid_sidebar.column_properties.photo.sizes.large')
            }, {
              value: '',
              text: $.t('screens.ds.grid_sidebar.column_properties.photo.sizes.original')
            }],
            defaultValue: ''
          }]
        },
        ...
        // URL
        {
          ...
          fields: [{
            text: $.t('screens.ds.grid_sidebar.column_properties.url.base_url'),
            type: 'text',
            name: 'format.baseUrl',
            prompt: $.t('screens.ds.grid_sidebar.column_properties.url.base_url_prompt'),
            extraClass: 'url'
          }]
        },
        ...
        // Display order
        {
          title: $.t('screens.ds.grid_sidebar.column_properties.display_order.title'),
          type: 'selectable',
          name: 'displayOrder',
          showIfData: true,
          onlyIf: {
          ...
          fields: [{
            type: 'repeater',
            addText: $.t('screens.ds.grid_sidebar.column_properties.display_order.new_item_button'),
            ...
            field: {
              type: 'text',
              text: $.t('screens.ds.grid_sidebar.column_properties.display_order.option'),
              name: 'orderItem'
            }
          }]
        },
        ...
        // Multiple choice value chooser
        {
          ...
          fields: [{
            type: 'repeater',
            addText: $.t('screens.ds.grid_sidebar.column_properties.multiple_choice.new_option_button'),
            name: 'dropDownList.values',
            minimum: 1,
            savedField: 'id',
            field: {
              type: 'text',
              text: $.t('screens.ds.grid_sidebar.column_properties.multiple_choice.option'),
              name: 'description'
            }
          }]
        },
        ...
        // Dataset Link
        {
          ...
          fields: [{
            ...
            prompt: $.t('screens.ds.grid_sidebar.column_common.linked_dataset.dataset_prompt')
          }, {
...

        {
          ...
          fields: [{
            text: $.t('screens.ds.grid_sidebar.column_properties.column_totals.total'),
            type: 'select',
            name: 'format.aggregate',
            prompt: $.t('screens.ds.grid_sidebar.column_properties.column_totals.total_prompt'),
            options: aggregateOptions
          }]
        },

        {
          title: $.t('screens.ds.grid_sidebar.column_properties.advanced.title'),
          type: 'selectable',
          name: 'advanced',
          onlyIf: {
            func: function() {
          ...
          fields: [{
            text: $.t('screens.ds.grid_sidebar.column_properties.advanced.api_identifier'),
            type: 'text',
            data: {
            ...
            type: 'repeater',
            addText: $.t('screens.ds.grid_sidebar.column_properties.advanced.new_rdf_button'),
            name: 'format.rdf',
            minimum: 0,
            field: {
              type: 'radioGroup',
              text: $.t('screens.ds.grid_sidebar.column_properties.advanced.semantics'),
              name: 'rdfGroup',
              options: [{
                type: 'select',
                name: 'stock',
                ...
                type: 'text',
                name: 'custom',
                prompt: $.t('screens.ds.grid_sidebar.column_properties.advanced.url'),
                extraClass: 'url'
              }]
            }
          }]
