(function() {
  ...
  this.Nomination = ServerModel.extend({
    ...
    addComment: function(comment, callback, errorCallback) {
      this.makeRequest({
        url: this.selfUrl + '/comments.json',
        type: 'POST',
    ...
    removeComment: function(commentId, successCallback, errorCallback) {
      this.makeRequest({
        url: this.selfUrl + '/comments/' + commentId + '.json',
        type: 'DELETE',
        success: successCallback,
        error: errorCallback
      });
    ...
    contactOwner: function(message, callback, errorCallback) {
      this.makeRequest({
        url: this.selfUrl + '?method=notifyNominator',
        type: 'POST',
    ...
    flagComment: function(id, successCallback, errorCallback) {
      var nom = this;
      nom.makeRequest({
        url: nom.selfUrl + '/comments/' + id + '.json',
        type: 'PUT',
        data: JSON.stringify({
          flags: ['flag']
        }),
    ...
    rate: function(isUp, successCallback, errorCallback) {
      this.makeRequest({
        url: this.selfUrl + '/ratings.json?thumbsUp=' + isUp,
        type: 'POST',
        success: successCallback,
        error: errorCallback
      });
