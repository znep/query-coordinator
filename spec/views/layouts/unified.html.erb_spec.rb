...
describe 'layouts/unified' do
  ...
  it 'does not make a core request in test mode' do
    ...
    expect(rendered).to match('<a class="logo" href="/"><img alt="" onerror="this.style.display=&quot;none&quot;" src="/socrata_site_chrome/images/socrata-logo-2c-dark.png" /><span class="site-name"></span></a>')
