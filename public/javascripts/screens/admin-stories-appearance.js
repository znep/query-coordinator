...
blist.publish.customizationApplication = {
    ...
    orientation:                            [ { selector: '.storiesContainer .storyTexts li', css: 'right', map: { left: 'inherit', right: 0 } },
                                              { selector: '.storiesContainer .storyTextbox', css: 'right', map: { left: 'inherit', right: 0 } },
                                              { selector: '.storiesContainer .storyPager', css: 'right', map: { left: 'inherit', right: 0 } },
                                              { selector: '.storiesContainer .storyImages li img', css: 'right', map: { left: 0, right: 'inherit' } },
                                              { selector: '.storiesContainer', attr: 'data-orientation' } ],
    box:    { alpha:                        [ { selector: '.storiesContainer .storyTextbox', css: 'opacity' } ],
              body:     { color:            [ { selector: '.storiesContainer .storyTexts li p', css: 'color' } ],
                          font_family:      [ { selector: '.storiesContainer .storyTexts li p', css: 'font-family' } ],
                          font_size:        [ { selector: '.storiesContainer .storyTexts li p', css: 'font-size', hasUnit: true } ],
                          shadow:           [ { selector: '.storiesContainer .storyTexts li p', css: 'text-shadow', callback: publishNS.applyShadow } ] },
    ...
    pager:  { disposition:                  [ { selector: '.storiesContainer .storyPager a', css: 'color', map: { light: '#ddd', dark: '#222' } },
              ...
              type:                         [ { selector: '.storiesContainer .storyPager a', css: 'text-indent', map: { bullets: '-9999px', numbers: '0' } },
                                              { selector: '.ie7 .storiesContainer .storyPager a', css: 'line-height', map: { bullets: '9999px', numbers: '0' } },
...
_.each([
{
    ...
    priority: 1,
    title: 'Text Box',
    subtitle: 'Customize the appearance of the text-based content area',
    noReset: true,
    ...
    priority: 2,
    title: 'Pager',
    subtitle: 'Customize the appearance of the story pager',
    noReset: true,
    dataSource: publishNS.resolveWorkingTheme,
    sections: [
    {
    ...
    priority: 3,
    title: 'Other',
    subtitle: 'Other customizable options on stories',
    noReset: true,
    dataSource: publishNS.resolveWorkingTheme,
    sections: [
    {
