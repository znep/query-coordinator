...
const CustomColorPaletteManager = rewire('../../src/dataProviders/CustomColorPaletteManager');
import { COLOR_PALETTES } from '../../src/views/SvgStyleConstants';
...
import { getInitialState } from '../authoringWorkflow/testStore';
...
describe('CustomColorPaletteManager', () => {
  ...
  describe('generateCustomColorPalette', () => {
    ...
    beforeEach(() => {
      ...
      __reset__ = CustomColorPaletteManager.__set__({
        TimeDataManager: {
          getData: timeStub
        },
        CategoricalDataManager: {
          getData: categoricalStub
        }
      });
    });
